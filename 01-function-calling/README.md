# Project 1 — Function Calling / Proyecto 1 — Function calling
...
```
Model requested tool: get_weather with {'city': 'La Plata'}
Code executed get_weather() and returned: 18°C, cloudy

Final answer from the model:
The weather in La Plata is 18°C, cloudy.
```
...
|----------|-------------------|
| `"What is the weather in La Plata?"` | Usa la herramienta y arma la respuesta final |
| `"Tell me a joke"` | Responde directo (entra al `else`) |
| `"What is the weather in Tucumán?"` | Usa la herramienta, pero como Tucumán no está en el dataset, la respuesta del modelo toma nuestro “No data available for Tucumán.” |
